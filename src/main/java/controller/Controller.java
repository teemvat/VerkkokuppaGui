...
public class Controller implements IControllerForEng, IControllerForView {   // UUSI
    ...
    public void startSimulation() {
        ...
        engine = new MyEngine(this,ui.getOrderHandlers(), ui.getWarehousers(), ui.getPackagers(),ui.getShippingIterval()); // luodaan uusi moottorisäie jokaista simulointia varten
